...
This paper is based of a previous paper by \cite{Eom:2006} which proposes the VR game platform that uses \texit{``Magic Wands''} to measure the players movements.
